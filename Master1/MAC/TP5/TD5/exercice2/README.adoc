...
.  Quel(s) patron(s) de conception permettent de résoudre ce problème ?
Justifiez et donnez le diagramme de classes correspondant. Implémentez la solution complète.
