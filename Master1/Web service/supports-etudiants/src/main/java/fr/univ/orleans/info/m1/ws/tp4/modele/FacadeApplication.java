...
public class FacadeApplication {
     ...
     */
    private final Map<String, Collection<Question>> questionsParUtilisateur;
     ...
     */
    public Question ajouterUneQuestion(String idUtilisateur, String libelleQuestion) {
     ...
     */
    public Collection<Question> getQuestionsAvecReponsesByUser(String idUtilisateur) throws UtilisateurInexistantException {
     ...
     */
    public Collection<Question> getQuestionsSansReponsesByUser(String idUtilisateur) throws UtilisateurInexistantException {
        if (this.questionsParUtilisateur.containsKey(idUtilisateur)) {
            return this.questionsParUtilisateur.get(idUtilisateur)
                    .stream()
     ...
     */
    public Collection<Question> getToutesLesQuestionsByUser(String idUtilisateur) throws UtilisateurInexistantException {
        if (this.questionsParUtilisateur.containsKey(idUtilisateur)) {
            return this.questionsParUtilisateur.get(idUtilisateur);
        } else {
            throw new UtilisateurInexistantException();
     ...
     */
    public Question getQuestionByIdPourUnUtilisateur(String idUtilisateur, String idQuestion) throws QuestionInexistanteException, AccessIllegalAUneQuestionException, UtilisateurInexistantException {
